...
public class QueryContainer {
    ...
    public QueryContainer addCompositeKey(FieldExtraction ref, String id) {
        return new QueryContainer(query, fields, attributes, combine(keysValues, new Tuple<>(ref, id)), keys, sort, trackHits,
            includeFrozen, limit);
    }
    ...
    public QueryContainer addColumn(FieldExtraction ref, String id) {
        return new QueryContainer(query, combine(fields, new Tuple<>(ref, id)), attributes, keysValues, keys, sort, trackHits,
            includeFrozen, limit);
    }
