...
class EqlBaseParser extends Parser {
  ...
  public static final int
    ...
    RULE_query = 3, RULE_sequenceParams = 4, RULE_sequence = 5, RULE_sampling = 6, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "sequence", "sampling", "join", "pipe", "joinKeys", "joinTerm", "sequenceTerm", 
  ...
  public static class SamplingContext extends ParserRuleContext {
    public JoinKeysContext by;
    public TerminalNode SAMPLING() { return getToken(EqlBaseParser.SAMPLING, 0); }
    ...
    @Override public int getRuleIndex() { return RULE_sampling; }
    @Override
    public void enterRule(ParseTreeListener listener) {
