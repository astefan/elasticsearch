...
public class BoxedQueryRequest implements QueryRequest {
    ...
    public BoxedQueryRequest(QueryRequest original, String timestamp, List<String> keyNames, Set<String> optionalKeys) {
        ...
        if (keyNames.isEmpty() == false) {
            for (String keyName : keyNames) {
                ...
                if (optionalKeys.contains(keyName) == false) {
    ...
    public BoxedQueryRequest keys(List<List<Object>> values) {
        ...
        if (CollectionUtils.isEmpty(values)) {
            ...
            for (int keyIndex = 0; keyIndex < keys.size(); keyIndex++) {
                ...
                if (hasNullValue && optionalKeys.contains(key)) {
