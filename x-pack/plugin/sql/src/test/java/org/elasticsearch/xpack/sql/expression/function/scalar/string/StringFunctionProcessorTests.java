...
public class StringFunctionProcessorTests extends AbstractWireSerializingTestCase<StringProcessor> {
    ...
    public void testLeft() {
        ...
        // validate the inputs
        SqlIllegalArgumentException siae1 = expectThrows(SqlIllegalArgumentException.class,
        ...
        SqlIllegalArgumentException siae2 = expectThrows(SqlIllegalArgumentException.class,
    ...
    public void testReplace() {
        ...
        SqlIllegalArgumentException siae3 = expectThrows(SqlIllegalArgumentException.class,
    ...
    public void testInsert() {
        ...
        assertEquals("A number is required; received [c]", siae3.getMessage());
        SqlIllegalArgumentException siae4 = expectThrows(SqlIllegalArgumentException.class,
